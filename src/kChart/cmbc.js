    ...
    require.config({
        paths:{ 
            ...
            'zrender/shape/FibonacciLine': './js/FibonacciLine',
            'zrender/shape/Quota': './js/Quota',
    ...
    require(
        ['zrender','zrender/shape/CrossLine','zrender/shape/Quota','zrender/shape/AssistLine','zrender/shape/FibonacciLine','zrender/shape/PriceLine','zrender/shape/Candle','zrender/shape/KAxis','zrender/shape/CandleQueue','zrender/shape/CandlePainter'],
        function(zrender) {
            ...
            var Quota = require('zrender/shape/Quota');
            var FibonacciLine = require('zrender/shape/FibonacciLine');
